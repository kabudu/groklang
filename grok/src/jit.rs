use cranelift_codegen::ir::{
    condcodes::IntCC, types, AbiParam, InstBuilder, Signature, UserFuncName,
};
            ...
            for instr in &func_block.instructions {
                ...
                match &instr.opcode {
                    ...
                    SpecializedOpcode::Generic(Opcode::JmpIfFalse(label)) => {
                        ...
                        let next_func_block = func_def
                            .blocks
                            .get(i + 1)
                            .ok_or("JmpIfFalse must have fallthrough")?;
